...
object FrogJump extends Solution[(Int, Int, Int), Int]{
...
Write a function:
class Solution { public int solution(int X, int Y, int D); } that, given three integers X, Y and D,
 ...
 */
  ...
  override def solution(tuple: (Int, Int, Int)): Int = { val (x, y, d) = tuple
